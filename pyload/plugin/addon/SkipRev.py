...
class Skip_rev(Addon):
    ...
    def _setup(self):
        ...
        if self.pyfile.has_status("skipped"):
    ...
    def download_preparing(self, pyfile):
        ...
        if revtokeep:
            ...
            queued = [True for link in self.pyload.api.get_package_data(pyfile.package().id).links \
    ...
    def download_failed(self, pyfile):
        ...
        for link in self.pyload.api.get_package_data(pyfile.package().id).links:
