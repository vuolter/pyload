...
class Account_info(Base_object):
...
class Captcha_task(Base_object):
...
class Config_section(Base_object):
...
class Download_info(Base_object):
...
class File_does_not_exists(Exception):
    __slots__ = ['fid']
...
class Interaction_task(Base_object):
...
class Online_check(Base_object):
    __slots__ = ['rid', 'data']
...
class Online_status(Base_object):
...
class Package_data(Base_object):
...
class Package_does_not_exists(Exception):
    __slots__ = ['pid']
...
class Server_status(Base_object):
...
class Service_call(Base_object):
...
class Service_does_not_exists(Exception):
